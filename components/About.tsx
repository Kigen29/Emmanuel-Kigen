...
const Main = () => {
  return (
    ...
    >
      ...
      As a dedicated software developer with international experience in Estonia and Kenya,
      ...
      that solve complex problems and create value for users. If you're looking for a qualified developer
      to bring your ideas to life and build scalable, high-performance applications, let's connect!
      Reach out to me via WhatsApp, Phone or Twitter, and let’s create something exceptional together.
      </p>
