  ...
  return (
    ...
    >
      ...
      <p className="kulim-park py-4 text-gray-600 max-w-[85%] m-auto text-justify">
        ...
        Estonia and Kenya. I am passionate about building innovative solutions that make a lasting impact. My expertise spans technologies like React
        ...
        via WhatsApp or Phone or even Twitter and let&apos;s create something exceptional
        together.
      </p>
